/**
 * „Yapaia Natur" — Landbedeckung und Wege treten hervor.
 *
...
export const YAPAIA_OUTDOOR_STYLE_NAME = 'Yapaia Natur';

export function buildYapaiaOutdoorStyle(): MapStyleDocument {
  return {
    version: 8,
