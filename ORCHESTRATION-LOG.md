...
**Basis-Branch:** main · **Aktuelle Welle:** Phase 2 (Routing/Nav) — G1 bestanden; **E03-Routing-Epic KOMPLETT (T1–T6)**; **E05-T1+T2+T3+T5 (Suche) + E04-T1+T2 (Nav-Kern + ETA) MERGED**. **Offen Richtung G2:** E04-T3 (Manöver-Logik+Ansagen+Tempolimit, braucht T1; Core+erste Web-Drive-Elemente), E04-T4 (Abweichung+Auto-Reroute 🔴, braucht T1→opus), E04-T5 (End-to-End Nav-Steuerung, braucht T1–T4); E05-T4 (Photon — Feasibility-Spike offen, Lite-Fallback als Sicherheitsnetz), E06-T3 (Profil-Reroute, braucht E04). **Nächste sinnvolle Reihenfolge:** E04-T3 → E04-T4 (opus) → E04-T5. G2-Kriterium (Golden-Routes) hat jetzt Framework+LI-Gate; echte DE-Restriktionsfälle = nightly-Nachrüstung (Daten)
