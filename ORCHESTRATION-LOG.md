...
**Basis-Branch:** main · **Aktuelle Welle:** Phase 2 (Routing/Nav) — G1 bestanden; **E03-Routing-Epic KOMPLETT (T1–T6)**; **E05-T1+T2+T3+T5 (Suche) + E04-T1+T2+T3+T4 (Nav-Kern + ETA + Manöver + Reroute) MERGED — Navigation fast komplett**. **Offen Richtung G2:** E04-T5 (End-to-End Nav-Steuerung + Ziel-Convenience „Navigation starten", braucht T1–T4; verkabelt reroute-Kontext/avoidances/Waypoint-Pruning aus Frontend, NAV_ENABLED-Gate); E05-T4 (Photon — Feasibility-Spike offen, Lite-Fallback als Sicherheitsnetz), E06-T3 (Profil-Reroute, braucht E04). **Nächste sinnvolle Reihenfolge:** E04-T5 (schließt Navigations-Epic + G2-Herzstück) → dann E05-T4-Spike / E06-T3. E04-T5 muss StartInput.reroute (waypoints + E03-T4-avoidances) vom Frontend-Nav-Start füttern (in E04-T4 verkabelt, wartet auf Zulieferung). G2-Kriterium (Golden-Routes) hat jetzt Framework+LI-Gate; echte DE-Restriktionsfälle = nightly-Nachrüstung (Daten)
