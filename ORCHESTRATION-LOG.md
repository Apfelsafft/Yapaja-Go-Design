...
| E03-T4 | sonnet | 1 | ⏳ dispatched | — | Vermeidungen: shared RouteRequest +exclude_locations/polygons/avoid_overrides (minor bump), Core-Valhalla-Mapping (lon/lat!), Web avoid-Chips + „Abschnitt meiden"→Reroute + Vermeidungsliste. Blast-Radius shared+core+web |
