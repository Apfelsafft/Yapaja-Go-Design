...
| E03-T2 | opus | 1 | ⏳ dispatched | — | 🔴 RoutingService: Profil→Valhalla-Truck-Costing (Sicherheitskern), checkRoute-Plausibilität, Cache, Fehlerpfade. Mock-basierte Tests (echte LI-Integration = CI-Follow-up, lokal nicht lauffähig) |
