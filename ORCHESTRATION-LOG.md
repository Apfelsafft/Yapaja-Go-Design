...
**Basis-Branch:** main · **Aktuelle Welle:** Phase 2 (Routing/Nav) — G1 bestanden; **E03-Routing-Epic KOMPLETT (T1–T6)**. **Offen Richtung G2:** E05 (Suche/Favoriten), E04 (Navigation Turn-by-Turn), E06-T3 (Profil-Reroute, braucht E04). G2-Kriterium (Golden-Routes) hat jetzt Framework+LI-Gate; echte DE-Restriktionsfälle = nightly-Nachrüstung (Daten)
...
| E05-T1 | sonnet | 1 | ⏳ dispatched | — | SearchService (Welle 2a): Coordinate-Parser→Photon→Nominatim(rate-limit), SearchResult-Schema (shared minor), out_of_coverage-Marking. Photon-Integration = E05-T4-Follow-up (CI-only), lokal mock-verifiziert |
...
<!-- TODO Kosmetik: Remote-Branch spike/valhalla-feasibility + gemergte task/*-Branches über GitHub-UI löschen (git push --delete scheitert am Proxy) -->
