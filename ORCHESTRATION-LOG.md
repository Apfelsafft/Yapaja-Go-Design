...
| E03-T5 | opus | 1 | ⏳ dispatched | — | 🔴 Golden-Route-Suite (Merge-Blocker, User-Wahl Option 1). Framework + LI-Fälle grün im PR-CI (distance+monotonic), DE-restriction kuratiert als nightly-Slot. Neuer CI-Job golden-routes-li (core+Valhalla zusammen → löst E03-T2-Integrationsgate ein). Routen-Verifikation CI-only |
