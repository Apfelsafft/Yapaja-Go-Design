...
**Basis-Branch:** main · **Aktuelle Welle:** Phase 2 (Routing/Nav) — G1 bestanden; **E03-Routing-Epic KOMPLETT (T1–T6)**; **E05-T1+T2 (Suche Core+UI) MERGED**. **Offen Richtung G2:** E05-T3 (Favoriten/Verlauf), E05-T4 (Photon — Feasibility-Spike offen), E05-T5 (Lite-Suchindex W-12), E04 (Navigation Turn-by-Turn; T1/T4 sicherheitskritisch→opus), E06-T3 (Profil-Reroute, braucht E04). G2-Kriterium (Golden-Routes) hat jetzt Framework+LI-Gate; echte DE-Restriktionsfälle = nightly-Nachrüstung (Daten)
